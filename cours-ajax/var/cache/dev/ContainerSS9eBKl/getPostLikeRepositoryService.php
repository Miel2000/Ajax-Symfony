...
// Returns the private 'App\Repository\PostLikeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PostLikeRepository.php';

return $this->privates['App\\Repository\\PostLikeRepository'] = new \App\Repository\PostLikeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
